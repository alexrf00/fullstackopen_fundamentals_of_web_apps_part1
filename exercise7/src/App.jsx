...
const Feedback = ( {feedbackGetter: {good,neutral,bad,all,average,positive}}) => (<div>good {good},<br/> neutral {neutral}<br/> bad {bad}<br/>all {all}<br/> average {average}<br/> positive {positive} %</div>)
